...
require (
	...
	code.cloudfoundry.org/cli-plugin-repo v0.0.0-20250108022042-d8ac871f14f6
	code.cloudfoundry.org/cli/integration/assets/hydrabroker v0.0.0-20250114205910-0d1cbbc0a312
	code.cloudfoundry.org/clock v1.28.0
	code.cloudfoundry.org/diego-ssh v0.0.0-20241210012033-4d6c6f7c83ad
