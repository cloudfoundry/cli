...
type CloudControllerClient interface {
	...
	CreateServiceBroker(name, username, password, url, spaceGUID string) (ccv3.JobURL, ccv3.Warnings, error)
	...
	DeleteServiceBroker(serviceBrokerGUID string) (ccv3.Warnings, error)
