...
type CloudControllerClient interface {
	...
	DeleteServiceInstance(serviceInstanceGUID string) (ccv3.JobURL, ccv3.Warnings, error)
	...
	GetApplicationRevisions(appGUID string) ([]ccv3.Revision, ccv3.Warnings, error)
