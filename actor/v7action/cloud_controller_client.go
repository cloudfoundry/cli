...
type CloudControllerClient interface {
	...
	SharePrivateDomainToOrgs(domainGuid string, sharedOrgs resources.SharedOrgs) (ccv3.Warnings, error)
	...
	UpdateResourceMetadata(resource string, resourceGUID string, metadata resources.Metadata) (resources.ResourceMetadata, ccv3.Warnings, error)
	UpdateResourceMetadataAsync(resource string, resourceGUID string, metadata resources.Metadata) (ccv3.JobURL, ccv3.Warnings, error)
