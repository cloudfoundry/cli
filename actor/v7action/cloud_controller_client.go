...
type CloudControllerClient interface {
	...
	CreateAccessRule(accessRule resources.AccessRule) (resources.AccessRule, ccv3.Warnings, error)
	...
	DeleteAccessRule(guid string) (ccv3.JobURL, ccv3.Warnings, error)
	...
	GetAccessRules(query ...ccv3.Query) ([]resources.AccessRule, ccv3.IncludedResources, ccv3.Warnings, error)
