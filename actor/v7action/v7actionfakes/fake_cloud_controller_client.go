...
type FakeCloudControllerClient struct {
	...
	GetRolesStub        func(...ccv3.Query) ([]ccv3.Role, ccv3.Warnings, error)
...
func (fake *FakeCloudControllerClient) GetRoles(arg1 ...ccv3.Query) ([]ccv3.Role, ccv3.Warnings, error) {
...
func (fake *FakeCloudControllerClient) GetRolesCalls(stub func(...ccv3.Query) ([]ccv3.Role, ccv3.Warnings, error)) {
	fake.getRolesMutex.Lock()
...
func (fake *FakeCloudControllerClient) GetRolesReturns(result1 []ccv3.Role, result2 ccv3.Warnings, result3 error) {
	fake.getRolesMutex.Lock()
	defer fake.getRolesMutex.Unlock()
...
func (fake *FakeCloudControllerClient) GetRolesReturnsOnCall(i int, result1 []ccv3.Role, result2 ccv3.Warnings, result3 error) {
	fake.getRolesMutex.Lock()
	defer fake.getRolesMutex.Unlock()
	fake.GetRolesStub = nil
