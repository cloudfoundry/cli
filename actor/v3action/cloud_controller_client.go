...
type CloudControllerClient interface {
	...
	PatchApplicationProcessHealthCheck(processGUID string, processHealthCheckType string, processHealthCheckEndpoint string, processInvocationTimeout int) (ccv3.Process, ccv3.Warnings, error)
