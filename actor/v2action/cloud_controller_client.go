...
type CloudControllerClient interface {
	...
	GetSpaceRunningSecurityGroupsBySpace(spaceGUID string, filters ...ccv2.Filter) ([]ccv2.SecurityGroup, ccv2.Warnings, error)
	...
	GetSpaceStagingSecurityGroupsBySpace(spaceGUID string, filters ...ccv2.Filter) ([]ccv2.SecurityGroup, ccv2.Warnings, error)
