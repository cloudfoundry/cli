...
func (fake *FakeV2Actor) CreateApplicationManifestByNameAndSpace(arg1 string, arg2 string) (manifest.Application, v2action.Warnings, error) {
	...
	stub := fake.CreateApplicationManifestByNameAndSpaceStub
...
func (fake *FakeV2Actor) GetServiceInstanceSharedTosByServiceInstance(arg1 string) ([]v2action.ServiceInstanceSharedTo, v2action.Warnings, error) {
	...
	stub := fake.GetServiceInstanceSharedTosByServiceInstanceStub
...
func (fake *FakeV2Actor) GetSpaceByOrganizationAndName(arg1 string, arg2 string) (v2action.Space, v2action.Warnings, error) {
	...
	stub := fake.GetSpaceByOrganizationAndNameStub
