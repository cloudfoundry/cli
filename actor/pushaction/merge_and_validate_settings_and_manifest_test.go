...
var _ = Describe("MergeAndValidateSettingsAndManifest", func() {
	...
	DescribeTable("validation errors",
		...
		Entry("CommandLineOptionsWithMultipleAppsError", CommandLineSettings{BuildpackName: "some-buildpack"}, []manifest.Application{{Name: "some-name-1"}, {Name: "some-name-2"}}, CommandLineOptionsWithMultipleAppsError{}),
		Entry("CommandLineOptionsWithMultipleAppsError", CommandLineSettings{Command: "some-command"}, []manifest.Application{{Name: "some-name-1"}, {Name: "some-name-2"}}, CommandLineOptionsWithMultipleAppsError{}),
