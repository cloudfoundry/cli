...
var _ = Describe("CommandLineSettings", func() {
	...
	DescribeTable("OverrideManifestSettings",
		...
		Entry("single buildpack overrides single buildpack",
			...
			CommandLineSettings{Buildpack: "sixpack"},
		...
		Entry("handles autodetect on single buildpack",
			...
			CommandLineSettings{Buildpack: "default"},
			manifest.Application{Buildpack: types.FilteredString{IsSet: true, Value: "not-sixpack"}},
		...
		Entry("overrides droplet path",
			CommandLineSettings{DropletPath: "some-path", CurrentDirectory: "some-dir"},
			manifest.Application{DropletPath: "no-path"},
			manifest.Application{DropletPath: "some-path", Path: ""},
		),
		...
		Entry("no path, docker image, or droplet",
			CommandLineSettings{CurrentDirectory: "some-dir"},
			manifest.Application{},
			manifest.Application{Path: "some-dir"},
		),
