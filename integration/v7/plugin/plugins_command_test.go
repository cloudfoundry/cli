...
var _ = Describe("plugins command", func() {
	...
	When("plugins are installed", func() {
		When("there are multiple plugins", func() {
			BeforeEach(func() {
				helpers.InstallConfigurablePlugin("configurable_plugin_v7", "I-should-be-sorted-first", "1.2.0", []helpers.PluginCommand{
					{Name: "command-1", Help: "some-command-1"},
					{Name: "Better-command", Help: "some-better-command"},
					{Name: "command-2", Help: "some-command-2"},
				})
				helpers.InstallConfigurablePlugin("configurable_plugin_v7", "sorted-third", "2.0.1", []helpers.PluginCommand{
					{Name: "banana-command", Help: "banana-command"},
				})
				helpers.InstallConfigurablePlugin("configurable_plugin_v7", "i-should-be-sorted-second", "1.0.0", []helpers.PluginCommand{
		...
		When("plugin version information is 0.0.0", func() {
			BeforeEach(func() {
				helpers.InstallConfigurablePlugin("configurable_plugin_v7", "some-plugin", "0.0.0", []helpers.PluginCommand{
					{Name: "banana-command", Help: "banana-command"},
				})
			})
		...
		When("a plugin command has an alias", func() {
			BeforeEach(func() {
				helpers.InstallConfigurablePlugin("configurable_plugin_v7", "some-plugin", "1.0.0", []helpers.PluginCommand{
		...
		When("the --outdated flag is provided", func() {
			...
			When("there is 1 repository", func() {
				...
				When("nothing is outdated", func() {
					BeforeEach(func() {
						helpers.InstallConfigurablePlugin("configurable_plugin_v7", "plugin-1", "1.0.0", []helpers.PluginCommand{
							{Name: "banana-command-1", Help: "banana-command"},
						})
						helpers.InstallConfigurablePlugin("configurable_plugin_v7", "plugin-2", "2.0.0", []helpers.PluginCommand{
				...
				When("the plugins are outdated", func() {
					BeforeEach(func() {
						helpers.InstallConfigurablePlugin("configurable_plugin_v7", "plugin-1", "0.9.0", []helpers.PluginCommand{
							{Name: "banana-command-1", Help: "banana-command"},
						})
						helpers.InstallConfigurablePlugin("configurable_plugin_v7", "plugin-2", "1.9.0", []helpers.PluginCommand{
							{Name: "banana-command-2", Help: "banana-command"},
						})
					})
			...
			When("multiple repositories are registered", func() {
				...
				When("the same plugin is outdated from multiple repositories", func() {
					BeforeEach(func() {
						...
						helpers.InstallConfigurablePlugin("configurable_plugin_v7", "plugin-3", "2.9.0", []helpers.PluginCommand{
