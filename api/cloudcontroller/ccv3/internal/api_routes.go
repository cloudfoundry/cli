...
var APIRoutes = []Route{
	{Path: "/", Method: http.MethodGet, Name: GetApplicationsRequest, Resource: AppsResource},
	...
	{Path: "/", Method: http.MethodGet, Name: GetOrganizationsRequest, Resource: OrgsResource},
	...
	{Path: "/:app_guid/actions/apply_manifest", Method: http.MethodPost, Name: PostApplicationActionApplyManifest, Resource: AppsResource},
	{Path: "/:app_guid/actions/start", Method: http.MethodPost, Name: PostApplicationActionStartRequest, Resource: AppsResource},
	{Path: "/:app_guid/actions/stop", Method: http.MethodPost, Name: PostApplicationActionStopRequest, Resource: AppsResource},
	{Path: "/:app_guid/droplets/current", Method: http.MethodGet, Name: GetApplicationDropletCurrentRequest, Resource: AppsResource},
	{Path: "/:app_guid/env", Method: http.MethodGet, Name: GetApplicationEnvRequest, Resource: AppsResource},
	...
	{Path: "/:app_guid/processes", Method: http.MethodGet, Name: GetApplicationProcessesRequest, Resource: AppsResource},
	{Path: "/:app_guid/processes/:type", Method: http.MethodGet, Name: GetApplicationProcessRequest, Resource: AppsResource},
	{Path: "/:app_guid/processes/:type/actions/scale", Method: http.MethodPost, Name: PostApplicationProcessActionScaleRequest, Resource: AppsResource},
	...
	{Path: "/:app_guid/tasks", Method: http.MethodGet, Name: GetApplicationTasksRequest, Resource: AppsResource},
	{Path: "/:app_guid/tasks", Method: http.MethodPost, Name: PostApplicationTasksRequest, Resource: AppsResource},
	...
	{Path: "/:organization_guid/relationships/default_isolation_segment", Method: http.MethodGet, Name: GetOrganizationRelationshipDefaultIsolationSegmentRequest, Resource: OrgsResource},
	{Path: "/:organization_guid/relationships/default_isolation_segment", Method: http.MethodPatch, Name: PatchOrganizationRelationshipDefaultIsolationSegmentRequest, Resource: OrgsResource},
	{Path: "/:package_guid", Method: http.MethodGet, Name: GetPackageRequest, Resource: PackagesResource},
	{Path: "/:process_guid", Method: http.MethodPatch, Name: PatchProcessRequest, Resource: ProcessesResource},
	{Path: "/:process_guid/stats", Method: http.MethodGet, Name: GetProcessStatsRequest, Resource: ProcessesResource},
