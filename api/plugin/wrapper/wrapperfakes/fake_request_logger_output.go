...
import (
	...
	wrapper "code.cloudfoundry.org/cli/api/plugin/wrapper"
)

type FakeRequestLoggerOutput struct {
	DisplayDumpStub        func(string) error
...
func (fake *FakeRequestLoggerOutput) DisplayDump(arg1 string) error {
...
func (fake *FakeRequestLoggerOutput) DisplayDumpCalls(stub func(string) error) {
	fake.displayDumpMutex.Lock()
	defer fake.displayDumpMutex.Unlock()
	fake.DisplayDumpStub = stub
}

func (fake *FakeRequestLoggerOutput) DisplayDumpArgsForCall(i int) string {
	fake.displayDumpMutex.RLock()
	defer fake.displayDumpMutex.RUnlock()
	argsForCall := fake.displayDumpArgsForCall[i]
