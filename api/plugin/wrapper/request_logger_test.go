...
import (
	...
	"code.cloudfoundry.org/cli/v7/api/plugin/pluginfakes"
	. "code.cloudfoundry.org/cli/v7/api/plugin/wrapper"
	"code.cloudfoundry.org/cli/v7/api/plugin/wrapper/wrapperfakes"
