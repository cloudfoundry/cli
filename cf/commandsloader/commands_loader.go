...
import (
	...
	"code.cloudfoundry.org/cli/v8/cf/commands/buildpack"
	"code.cloudfoundry.org/cli/v8/cf/commands/domain"
	"code.cloudfoundry.org/cli/v8/cf/commands/environmentvariablegroup"
	"code.cloudfoundry.org/cli/v8/cf/commands/featureflag"
	"code.cloudfoundry.org/cli/v8/cf/commands/organization"
	"code.cloudfoundry.org/cli/v8/cf/commands/plugin"
	"code.cloudfoundry.org/cli/v8/cf/commands/pluginrepo"
	"code.cloudfoundry.org/cli/v8/cf/commands/quota"
	"code.cloudfoundry.org/cli/v8/cf/commands/route"
	"code.cloudfoundry.org/cli/v8/cf/commands/routergroups"
	"code.cloudfoundry.org/cli/v8/cf/commands/securitygroup"
	"code.cloudfoundry.org/cli/v8/cf/commands/service"
	"code.cloudfoundry.org/cli/v8/cf/commands/serviceaccess"
	"code.cloudfoundry.org/cli/v8/cf/commands/serviceauthtoken"
	"code.cloudfoundry.org/cli/v8/cf/commands/servicebroker"
	"code.cloudfoundry.org/cli/v8/cf/commands/servicekey"
	"code.cloudfoundry.org/cli/v8/cf/commands/space"
	"code.cloudfoundry.org/cli/v8/cf/commands/spacequota"
