...
type FakeSecureDialer struct {
	DialStub        func(string, string, *ssh.ClientConfig) (sshCmd.SecureClient, error)
...
func (fake *FakeSecureDialer) Dial(arg1 string, arg2 string, arg3 *ssh.ClientConfig) (sshCmd.SecureClient, error) {
	fake.dialMutex.Lock()
...
func (fake *FakeSecureDialer) DialCalls(stub func(string, string, *ssh.ClientConfig) (sshCmd.SecureClient, error)) {
	fake.dialMutex.Lock()
...
func (fake *FakeSecureDialer) DialReturnsOnCall(i int, result1 sshCmd.SecureClient, result2 error) {
	fake.dialMutex.Lock()
	defer fake.dialMutex.Unlock()
	fake.DialStub = nil
