...
import (
	...
	sshCmd "code.cloudfoundry.org/cli/v7/cf/ssh"
	"code.cloudfoundry.org/cli/v7/cf/ssh/options"
	"code.cloudfoundry.org/cli/v7/cf/ssh/sshfakes"
	"code.cloudfoundry.org/cli/v7/cf/ssh/terminal"
	"code.cloudfoundry.org/cli/v7/cf/ssh/terminal/terminalfakes"
