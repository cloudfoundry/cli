...
type FakeEndpointRepository struct {
	GetCCInfoStub        func(string) (*core_config.CCInfo, string, error)
	getCCInfoMutex       sync.RWMutex
	getCCInfoArgsForCall []struct {
		arg1 string
	}
	getCCInfoReturns struct {
		result1 *core_config.CCInfo
		result2 string
		result3 error
	}
}

func (fake *FakeEndpointRepository) GetCCInfo(arg1 string) (*core_config.CCInfo, string, error) {
...
func (fake *FakeEndpointRepository) GetCCInfoReturns(result1 *core_config.CCInfo, result2 string, result3 error) {
...
var _ core_config.EndpointRepository = new(FakeEndpointRepository)
