...
import (
	...
	"code.cloudfoundry.org/cli/v8/cf/net/netfakes"
	"code.cloudfoundry.org/cli/v8/cf/terminal/terminalfakes"
	...
	testnet "code.cloudfoundry.org/cli/v8/cf/util/testhelpers/net"
