...
import (
	...
	"code.cloudfoundry.org/cli/v7/cf/api/copyapplicationsource/copyapplicationsourcefakes"
	"code.cloudfoundry.org/cli/v7/cf/api/organizations/organizationsfakes"
