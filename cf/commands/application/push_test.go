...
import (
	...
	"code.cloudfoundry.org/cli/v7/cf/actors/actorsfakes"
	"code.cloudfoundry.org/cli/v7/cf/api/apifakes"
	"code.cloudfoundry.org/cli/v7/cf/api/applications/applicationsfakes"
	"code.cloudfoundry.org/cli/v7/cf/api/authentication/authenticationfakes"
	"code.cloudfoundry.org/cli/v7/cf/api/resources"
	"code.cloudfoundry.org/cli/v7/cf/api/stacks/stacksfakes"
	"code.cloudfoundry.org/cli/v7/cf/appfiles/appfilesfakes"
	"code.cloudfoundry.org/cli/v7/cf/commandregistry"
	"code.cloudfoundry.org/cli/v7/cf/commandregistry/commandregistryfakes"
	"code.cloudfoundry.org/cli/v7/cf/commands/application"
	"code.cloudfoundry.org/cli/v7/cf/commands/application/applicationfakes"
	"code.cloudfoundry.org/cli/v7/cf/commands/service/servicefakes"
	...
	"code.cloudfoundry.org/cli/v7/cf/manifest"
	"code.cloudfoundry.org/cli/v7/cf/manifest/manifestfakes"
	...
	"code.cloudfoundry.org/cli/v7/util/generic"
