...
import (
	...
	"code.cloudfoundry.org/cli/v8/cf/actors/plugininstaller"
...
func (cmd *PluginInstall) SetDependency(deps commandregistry.Dependency, pluginCall bool) commandregistry.Command {
	...
	rpcService, err := pluginRPCService.NewRpcService(deps.TeePrinter, deps.TeePrinter, v3Config, deps.RepoLocator, pluginRPCService.NewCommandRunner(), deps.Logger, cmd.ui.Writer(), server, nil, nil, nil)
	if err != nil {
