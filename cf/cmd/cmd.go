...
import (
	...
	"code.cloudfoundry.org/cli/v8/cf/commandsloader"
...
func Main(traceEnv string, args []string) {
	...
	rpcService, err := rpc.NewRpcService(deps.TeePrinter, deps.TeePrinter, v3Config, deps.RepoLocator, rpc.NewCommandRunner(), deps.Logger, Writer, server, nil, nil, nil)
	if err != nil {
