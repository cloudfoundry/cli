...
import (
	...
	"code.cloudfoundry.org/cli/v7/cf/api/appevents"
	api_appfiles "code.cloudfoundry.org/cli/v7/cf/api/appfiles"
	"code.cloudfoundry.org/cli/v7/cf/api/appinstances"
	"code.cloudfoundry.org/cli/v7/cf/api/applicationbits"
	"code.cloudfoundry.org/cli/v7/cf/api/applications"
	"code.cloudfoundry.org/cli/v7/cf/api/authentication"
	"code.cloudfoundry.org/cli/v7/cf/api/copyapplicationsource"
	"code.cloudfoundry.org/cli/v7/cf/api/environmentvariablegroups"
	...
	"code.cloudfoundry.org/cli/v7/cf/api/password"
	"code.cloudfoundry.org/cli/v7/cf/api/quotas"
	"code.cloudfoundry.org/cli/v7/cf/api/securitygroups"
	"code.cloudfoundry.org/cli/v7/cf/api/securitygroups/defaults/running"
	"code.cloudfoundry.org/cli/v7/cf/api/securitygroups/defaults/staging"
	securitygroupspaces "code.cloudfoundry.org/cli/v7/cf/api/securitygroups/spaces"
	"code.cloudfoundry.org/cli/v7/cf/api/spacequotas"
	"code.cloudfoundry.org/cli/v7/cf/api/spaces"
	"code.cloudfoundry.org/cli/v7/cf/api/stacks"
	"code.cloudfoundry.org/cli/v7/cf/appfiles"
