...
import (
	...
	spaces "code.cloudfoundry.org/cli/cf/api/spaces"
	models "code.cloudfoundry.org/cli/cf/models"
)
...
type FakeSpaceRepository struct {
	...
	DeleteUnmappedRoutesStub        func(string) error
...
func (fake *FakeSpaceRepository) DeleteUnmappedRoutes(arg1 string) error {
...
func (fake *FakeSpaceRepository) DeleteUnmappedRoutesCallCount() int {
...
func (fake *FakeSpaceRepository) DeleteUnmappedRoutesCalls(stub func(string) error) {
	fake.deleteUnmappedRoutesMutex.Lock()
	defer fake.deleteUnmappedRoutesMutex.Unlock()
	fake.DeleteUnmappedRoutesStub = stub
}

func (fake *FakeSpaceRepository) DeleteUnmappedRoutesArgsForCall(i int) string {
	fake.deleteUnmappedRoutesMutex.RLock()
	defer fake.deleteUnmappedRoutesMutex.RUnlock()
...
func (fake *FakeSpaceRepository) DeleteUnmappedRoutesReturns(result1 error) {
	fake.deleteUnmappedRoutesMutex.Lock()
	defer fake.deleteUnmappedRoutesMutex.Unlock()
...
func (fake *FakeSpaceRepository) DeleteUnmappedRoutesReturnsOnCall(i int, result1 error) {
	fake.deleteUnmappedRoutesMutex.Lock()
	defer fake.deleteUnmappedRoutesMutex.Unlock()
	fake.DeleteUnmappedRoutesStub = nil
