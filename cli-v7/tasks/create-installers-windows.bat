...
MOVE %ROOT_DIR%\extracted-binaries\cf7-cli_winx64.exe cf.exe
...
7z a %ROOT_DIR%\winstallers\cf7-cli-installer_winx64.zip cf_installer.exe
...
MOVE %ROOT_DIR%\extracted-binaries\cf7-cli_win32.exe cf.exe

ISCC %ROOT_DIR%\cli-ci\ci\installers\windows\windows-installer-x86.iss

MOVE %ROOT_DIR%\cli-ci\ci\installers\windows\Output\mysetup.exe cf_installer.exe

7z a %ROOT_DIR%\winstallers\cf7-cli-installer_win32.zip cf_installer.exe
