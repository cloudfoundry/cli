...
func (repo LoggregatorLogsRepository) makeAndStartMessageSorter(messageQueue *PriorityQueue, outputChan chan *logmessage.Message, stopLoggingChan <-chan bool) (err error) {
