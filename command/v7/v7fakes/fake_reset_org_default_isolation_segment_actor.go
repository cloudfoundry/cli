...
func (fake *FakeResetOrgDefaultIsolationSegmentActor) ResetOrganizationDefaultIsolationSegment(arg1 string) (v7action.Warnings, error) {
...
func (fake *FakeResetOrgDefaultIsolationSegmentActor) ResetOrganizationDefaultIsolationSegmentCalls(stub func(string) (v7action.Warnings, error)) {
	fake.resetOrganizationDefaultIsolationSegmentMutex.Lock()
...
var _ v7.ResetOrgDefaultIsolationSegmentActor = new(FakeResetOrgDefaultIsolationSegmentActor)
