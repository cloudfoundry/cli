...
func (fake *FakeSetOrgDefaultIsolationSegmentActor) CloudControllerAPIVersionCalls(stub func() string) {
	fake.cloudControllerAPIVersionMutex.Lock()
...
func (fake *FakeSetOrgDefaultIsolationSegmentActor) GetIsolationSegmentByName(arg1 string) (v7action.IsolationSegment, v7action.Warnings, error) {
...
func (fake *FakeSetOrgDefaultIsolationSegmentActor) GetIsolationSegmentByNameCalls(stub func(string) (v7action.IsolationSegment, v7action.Warnings, error)) {
	fake.getIsolationSegmentByNameMutex.Lock()
...
func (fake *FakeSetOrgDefaultIsolationSegmentActor) SetOrganizationDefaultIsolationSegment(arg1 string, arg2 string) (v7action.Warnings, error) {
...
func (fake *FakeSetOrgDefaultIsolationSegmentActor) SetOrganizationDefaultIsolationSegmentCalls(stub func(string, string) (v7action.Warnings, error)) {
	fake.setOrganizationDefaultIsolationSegmentMutex.Lock()
...
var _ v7.SetOrgDefaultIsolationSegmentActor = new(FakeSetOrgDefaultIsolationSegmentActor)
