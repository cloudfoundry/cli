...
func (fake *FakeRestartActor) PollStart(arg1 string) (v7action.Warnings, error) {
...
func (fake *FakeRestartActor) PollStartCalls(stub func(string) (v7action.Warnings, error)) {
	fake.pollStartMutex.Lock()
	defer fake.pollStartMutex.Unlock()
	fake.PollStartStub = stub
}

func (fake *FakeRestartActor) PollStartArgsForCall(i int) string {
	fake.pollStartMutex.RLock()
	defer fake.pollStartMutex.RUnlock()
