...
func (fake *FakeFeatureFlagsActor) GetFeatureFlags() ([]v7action.FeatureFlag, v7action.Warnings, error) {
...
func (fake *FakeFeatureFlagsActor) GetFeatureFlagsCalls(stub func() ([]v7action.FeatureFlag, v7action.Warnings, error)) {
	fake.getFeatureFlagsMutex.Lock()
	defer fake.getFeatureFlagsMutex.Unlock()
	fake.GetFeatureFlagsStub = stub
}

func (fake *FakeFeatureFlagsActor) GetFeatureFlagsReturns(result1 []v7action.FeatureFlag, result2 v7action.Warnings, result3 error) {
	fake.getFeatureFlagsMutex.Lock()
	defer fake.getFeatureFlagsMutex.Unlock()
...
func (fake *FakeFeatureFlagsActor) GetFeatureFlagsReturnsOnCall(i int, result1 []v7action.FeatureFlag, result2 v7action.Warnings, result3 error) {
	fake.getFeatureFlagsMutex.Lock()
	defer fake.getFeatureFlagsMutex.Unlock()
	fake.GetFeatureFlagsStub = nil
...
var _ v7.FeatureFlagsActor = new(FakeFeatureFlagsActor)
