...
func (fake *FakeV3DropletsActor) GetApplicationDroplets(arg1 string, arg2 string) ([]v7action.Droplet, v7action.Warnings, error) {
...
func (fake *FakeV3DropletsActor) GetApplicationDropletsCalls(stub func(string, string) ([]v7action.Droplet, v7action.Warnings, error)) {
	fake.getApplicationDropletsMutex.Lock()
...
var _ v7.V3DropletsActor = new(FakeV3DropletsActor)
