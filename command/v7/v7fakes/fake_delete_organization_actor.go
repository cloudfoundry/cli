...
func (fake *FakeDeleteOrganizationActor) DeleteOrganization(arg1 string) (v7action.Warnings, error) {
...
func (fake *FakeDeleteOrganizationActor) DeleteOrganizationCalls(stub func(string) (v7action.Warnings, error)) {
	fake.deleteOrganizationMutex.Lock()
...
func (fake *FakeDeleteOrganizationActor) DeleteOrganizationReturns(result1 v7action.Warnings, result2 error) {
	fake.deleteOrganizationMutex.Lock()
	defer fake.deleteOrganizationMutex.Unlock()
...
func (fake *FakeDeleteOrganizationActor) DeleteOrganizationReturnsOnCall(i int, result1 v7action.Warnings, result2 error) {
	fake.deleteOrganizationMutex.Lock()
	defer fake.deleteOrganizationMutex.Unlock()
	fake.DeleteOrganizationStub = nil
...
var _ v7.DeleteOrganizationActor = new(FakeDeleteOrganizationActor)
