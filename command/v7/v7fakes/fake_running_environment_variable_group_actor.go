...
type FakeRunningEnvironmentVariableGroupActor struct {
...
func (fake *FakeRunningEnvironmentVariableGroupActor) GetEnvironmentVariableGroup(arg1 constant.EnvironmentVariableGroupName) (v7action.EnvironmentVariableGroup, v7action.Warnings, error) {
...
func (fake *FakeRunningEnvironmentVariableGroupActor) GetEnvironmentVariableGroupCallCount() int {
...
func (fake *FakeRunningEnvironmentVariableGroupActor) GetEnvironmentVariableGroupCalls(stub func(constant.EnvironmentVariableGroupName) (v7action.EnvironmentVariableGroup, v7action.Warnings, error)) {
	fake.getEnvironmentVariableGroupMutex.Lock()
	defer fake.getEnvironmentVariableGroupMutex.Unlock()
	fake.GetEnvironmentVariableGroupStub = stub
}

func (fake *FakeRunningEnvironmentVariableGroupActor) GetEnvironmentVariableGroupArgsForCall(i int) constant.EnvironmentVariableGroupName {
	fake.getEnvironmentVariableGroupMutex.RLock()
	defer fake.getEnvironmentVariableGroupMutex.RUnlock()
...
func (fake *FakeRunningEnvironmentVariableGroupActor) GetEnvironmentVariableGroupReturns(result1 v7action.EnvironmentVariableGroup, result2 v7action.Warnings, result3 error) {
	fake.getEnvironmentVariableGroupMutex.Lock()
	defer fake.getEnvironmentVariableGroupMutex.Unlock()
...
func (fake *FakeRunningEnvironmentVariableGroupActor) GetEnvironmentVariableGroupReturnsOnCall(i int, result1 v7action.EnvironmentVariableGroup, result2 v7action.Warnings, result3 error) {
	fake.getEnvironmentVariableGroupMutex.Lock()
	defer fake.getEnvironmentVariableGroupMutex.Unlock()
	fake.GetEnvironmentVariableGroupStub = nil
...
func (fake *FakeRunningEnvironmentVariableGroupActor) Invocations() map[string][][]interface{} {
...
func (fake *FakeRunningEnvironmentVariableGroupActor) recordInvocation(key string, args []interface{}) {
...
var _ v7.RunningEnvironmentVariableGroupActor = new(FakeRunningEnvironmentVariableGroupActor)
