...
type FakeSetRunningEnvironmentVariableGroupActor struct {
...
func (fake *FakeSetRunningEnvironmentVariableGroupActor) SetEnvironmentVariableGroup(arg1 constant.EnvironmentVariableGroupName, arg2 ccv3.EnvironmentVariables) (v7action.Warnings, error) {
...
func (fake *FakeSetRunningEnvironmentVariableGroupActor) SetEnvironmentVariableGroupCallCount() int {
...
func (fake *FakeSetRunningEnvironmentVariableGroupActor) SetEnvironmentVariableGroupCalls(stub func(constant.EnvironmentVariableGroupName, ccv3.EnvironmentVariables) (v7action.Warnings, error)) {
	fake.setEnvironmentVariableGroupMutex.Lock()
	defer fake.setEnvironmentVariableGroupMutex.Unlock()
	fake.SetEnvironmentVariableGroupStub = stub
}

func (fake *FakeSetRunningEnvironmentVariableGroupActor) SetEnvironmentVariableGroupArgsForCall(i int) (constant.EnvironmentVariableGroupName, ccv3.EnvironmentVariables) {
	fake.setEnvironmentVariableGroupMutex.RLock()
	defer fake.setEnvironmentVariableGroupMutex.RUnlock()
...
func (fake *FakeSetRunningEnvironmentVariableGroupActor) SetEnvironmentVariableGroupReturns(result1 v7action.Warnings, result2 error) {
	fake.setEnvironmentVariableGroupMutex.Lock()
	defer fake.setEnvironmentVariableGroupMutex.Unlock()
...
func (fake *FakeSetRunningEnvironmentVariableGroupActor) SetEnvironmentVariableGroupReturnsOnCall(i int, result1 v7action.Warnings, result2 error) {
	fake.setEnvironmentVariableGroupMutex.Lock()
	defer fake.setEnvironmentVariableGroupMutex.Unlock()
	fake.SetEnvironmentVariableGroupStub = nil
...
func (fake *FakeSetRunningEnvironmentVariableGroupActor) Invocations() map[string][][]interface{} {
...
func (fake *FakeSetRunningEnvironmentVariableGroupActor) recordInvocation(key string, args []interface{}) {
...
var _ v7.SetRunningEnvironmentVariableGroupActor = new(FakeSetRunningEnvironmentVariableGroupActor)
