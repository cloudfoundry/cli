...
func (fake *FakeV3RestartActor) GetApplicationByNameAndSpace(arg1 string, arg2 string) (v7action.Application, v7action.Warnings, error) {
...
func (fake *FakeV3RestartActor) GetApplicationByNameAndSpaceCalls(stub func(string, string) (v7action.Application, v7action.Warnings, error)) {
	fake.getApplicationByNameAndSpaceMutex.Lock()
...
func (fake *FakeV3RestartActor) GetApplicationByNameAndSpaceReturns(result1 v7action.Application, result2 v7action.Warnings, result3 error) {
	fake.getApplicationByNameAndSpaceMutex.Lock()
	defer fake.getApplicationByNameAndSpaceMutex.Unlock()
...
func (fake *FakeV3RestartActor) GetApplicationByNameAndSpaceReturnsOnCall(i int, result1 v7action.Application, result2 v7action.Warnings, result3 error) {
	fake.getApplicationByNameAndSpaceMutex.Lock()
	defer fake.getApplicationByNameAndSpaceMutex.Unlock()
	fake.GetApplicationByNameAndSpaceStub = nil
...
func (fake *FakeV3RestartActor) StartApplication(arg1 string) (v7action.Application, v7action.Warnings, error) {
...
func (fake *FakeV3RestartActor) StartApplicationCalls(stub func(string) (v7action.Application, v7action.Warnings, error)) {
	fake.startApplicationMutex.Lock()
...
func (fake *FakeV3RestartActor) StartApplicationReturns(result1 v7action.Application, result2 v7action.Warnings, result3 error) {
	fake.startApplicationMutex.Lock()
	defer fake.startApplicationMutex.Unlock()
...
func (fake *FakeV3RestartActor) StartApplicationReturnsOnCall(i int, result1 v7action.Application, result2 v7action.Warnings, result3 error) {
	fake.startApplicationMutex.Lock()
	defer fake.startApplicationMutex.Unlock()
	fake.StartApplicationStub = nil
...
func (fake *FakeV3RestartActor) StopApplication(arg1 string) (v7action.Warnings, error) {
...
func (fake *FakeV3RestartActor) StopApplicationCalls(stub func(string) (v7action.Warnings, error)) {
	fake.stopApplicationMutex.Lock()
...
func (fake *FakeV3RestartActor) StopApplicationReturns(result1 v7action.Warnings, result2 error) {
	fake.stopApplicationMutex.Lock()
	defer fake.stopApplicationMutex.Unlock()
...
func (fake *FakeV3RestartActor) StopApplicationReturnsOnCall(i int, result1 v7action.Warnings, result2 error) {
	fake.stopApplicationMutex.Lock()
	defer fake.stopApplicationMutex.Unlock()
	fake.StopApplicationStub = nil
...
var _ v7.V3RestartActor = new(FakeV3RestartActor)
