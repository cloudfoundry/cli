...
type Actor interface {
	...
	CreateManagedServiceInstance(managedServiceInstanceParams v7action.ManagedServiceInstanceParams) (chan v7action.PollJobEvent, v7action.Warnings, error)
	...
	GetServiceKeysByServiceInstance(serviceInstanceName, spaceGUID string) ([]string, v7action.Warnings, error)
