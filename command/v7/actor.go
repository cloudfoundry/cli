...
type Actor interface {
	...
	AddAccessRule(ruleName, domainName, selector, hostname, path string) (v7action.Warnings, error)
	...
	DeleteAccessRule(ruleName, domainName, hostname, path string) (v7action.Warnings, error)
