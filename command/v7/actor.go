...
import (
	...
	uaa "code.cloudfoundry.org/cli/v9/api/uaa/constant"
...
type Actor interface {
	...
	CreatePrivateDomain(domainName string, orgName string, enforceAccessRules bool, accessRulesScope string) (v7action.Warnings, error)
	...
	CreateSharedDomain(domainName string, internal bool, routerGroupName string, enforceAccessRules bool, accessRulesScope string) (v7action.Warnings, error)
	...
	DeleteApplicationByNameAndSpace(name, spaceGUID string, deleteRoutes bool) (chan v7action.PollJobEvent, v7action.Warnings, error)
	...
	DeleteOrganization(orgName string) (chan v7action.PollJobEvent, v7action.Warnings, error)
	...
	DeleteSpaceByNameAndOrganizationName(spaceName string, orgName string) (chan v7action.PollJobEvent, v7action.Warnings, error)
	...
	GetInfoResponse() (v7action.Info, v7action.Warnings, error)
	...
	GetRootResponse() (v7action.Root, v7action.Warnings, error)
	...
	GetRoutePolicyLabels(routeURL string, spaceGUID string, source string) (map[string]types.NullString, v7action.Warnings, error)
	...
	GetServiceInstanceByGUID(serviceInstanceGUID string) (resources.ServiceInstance, v7action.Warnings, error)
	...
	ListAppBindings(params v7action.ListAppBindingParams) ([]resources.ServiceCredentialBinding, v7action.Warnings, error)
