...
type Actor interface {
	...
	DeleteServiceInstance(serviceInstanceName, spaceGUID string, wait bool) (v7action.ServiceInstanceDeleteState, v7action.Warnings, error)
	...
	UpdateManagedServiceInstance(serviceInstanceName, spaceGUID string, serviceInstanceUpdates v7action.ServiceInstanceUpdateManagedParams) (v7action.Warnings, error)
	UpgradeServiceInstance(serviceInstanceName, spaceGUID string) (v7action.Warnings, error)
