...
var _ = Describe("set-org-default-isolation-segment Command", func() {
	var (
		cmd              v7.SetOrgDefaultIsolationSegmentCommand
		testUI           *ui.UI
		fakeConfig       *commandfakes.FakeConfig
		fakeSharedActor  *commandfakes.FakeSharedActor
		fakeActor        *v7fakes.FakeSetOrgDefaultIsolationSegmentActor
		fakeActorV2      *v7fakes.FakeSetOrgDefaultIsolationSegmentActorV2
		binaryName       string
		executeErr       error
	...
	BeforeEach(func() {
		...
		fakeActor = new(v7fakes.FakeSetOrgDefaultIsolationSegmentActor)
		fakeActorV2 = new(v7fakes.FakeSetOrgDefaultIsolationSegmentActorV2)
