...
var _ = Describe("reset-org-default-isolation-segment Command", func() {
	var (
		cmd             v7.ResetOrgDefaultIsolationSegmentCommand
		testUI          *ui.UI
		fakeConfig      *commandfakes.FakeConfig
		fakeSharedActor *commandfakes.FakeSharedActor
		fakeActor       *v7fakes.FakeResetOrgDefaultIsolationSegmentActor
		fakeActorV2     *v7fakes.FakeResetOrgDefaultIsolationSegmentActorV2
		binaryName      string
		executeErr      error
		orgName         string
	)
	...
	BeforeEach(func() {
		...
		fakeActor = new(v7fakes.FakeResetOrgDefaultIsolationSegmentActor)
		fakeActorV2 = new(v7fakes.FakeResetOrgDefaultIsolationSegmentActorV2)
