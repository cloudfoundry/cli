...
var _ = Describe("set-space-isolation-segment Command", func() {
	var (
		cmd              v7.SetSpaceIsolationSegmentCommand
		testUI           *ui.UI
		fakeConfig       *commandfakes.FakeConfig
		fakeSharedActor  *commandfakes.FakeSharedActor
		fakeActor        *v7fakes.FakeSetSpaceIsolationSegmentActor
		fakeActorV2      *v7fakes.FakeSetSpaceIsolationSegmentActorV2
		binaryName       string
		executeErr       error
	...
	BeforeEach(func() {
		...
		fakeActor = new(v7fakes.FakeSetSpaceIsolationSegmentActor)
		fakeActorV2 = new(v7fakes.FakeSetSpaceIsolationSegmentActorV2)
