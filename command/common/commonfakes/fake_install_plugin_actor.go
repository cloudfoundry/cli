...
type FakeInstallPluginActor struct {
	...
	GetPluginInfoFromConfigStub        func(pluginName string) (pluginaction.PluginInfo, error)
	getPluginInfoFromConfigMutex       sync.RWMutex
	getPluginInfoFromConfigArgsForCall []struct {
		pluginName string
	}
	getPluginInfoFromConfigReturns struct {
		result1 pluginaction.PluginInfo
		result2 error
	}
	getPluginInfoFromConfigReturnsOnCall map[int]struct {
		result1 pluginaction.PluginInfo
		result2 error
	}
...
func (fake *FakeInstallPluginActor) GetPluginInfoFromConfig(pluginName string) (pluginaction.PluginInfo, error) {
	fake.getPluginInfoFromConfigMutex.Lock()
	ret, specificReturn := fake.getPluginInfoFromConfigReturnsOnCall[len(fake.getPluginInfoFromConfigArgsForCall)]
	fake.getPluginInfoFromConfigArgsForCall = append(fake.getPluginInfoFromConfigArgsForCall, struct {
		pluginName string
	}{pluginName})
	fake.recordInvocation("GetPluginInfoFromConfig", []interface{}{pluginName})
	fake.getPluginInfoFromConfigMutex.Unlock()
	if fake.GetPluginInfoFromConfigStub != nil {
		return fake.GetPluginInfoFromConfigStub(pluginName)
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.getPluginInfoFromConfigReturns.result1, fake.getPluginInfoFromConfigReturns.result2
}

func (fake *FakeInstallPluginActor) GetPluginInfoFromConfigCallCount() int {
	fake.getPluginInfoFromConfigMutex.RLock()
	defer fake.getPluginInfoFromConfigMutex.RUnlock()
	return len(fake.getPluginInfoFromConfigArgsForCall)
}

func (fake *FakeInstallPluginActor) GetPluginInfoFromConfigArgsForCall(i int) string {
	fake.getPluginInfoFromConfigMutex.RLock()
	defer fake.getPluginInfoFromConfigMutex.RUnlock()
	return fake.getPluginInfoFromConfigArgsForCall[i].pluginName
}

func (fake *FakeInstallPluginActor) GetPluginInfoFromConfigReturns(result1 pluginaction.PluginInfo, result2 error) {
	fake.GetPluginInfoFromConfigStub = nil
	fake.getPluginInfoFromConfigReturns = struct {
		result1 pluginaction.PluginInfo
		result2 error
	}{result1, result2}
}

func (fake *FakeInstallPluginActor) GetPluginInfoFromConfigReturnsOnCall(i int, result1 pluginaction.PluginInfo, result2 error) {
	fake.GetPluginInfoFromConfigStub = nil
	if fake.getPluginInfoFromConfigReturnsOnCall == nil {
		fake.getPluginInfoFromConfigReturnsOnCall = make(map[int]struct {
			result1 pluginaction.PluginInfo
			result2 error
		})
	}
	fake.getPluginInfoFromConfigReturnsOnCall[i] = struct {
		result1 pluginaction.PluginInfo
		result2 error
	}{result1, result2}
}
