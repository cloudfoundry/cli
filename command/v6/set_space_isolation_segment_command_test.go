...
var _ = Describe("set-space-isolation-segment Command", func() {
	var (
		...
		fakeActor        *v6fakes.FakeSetSpaceIsolationSegmentActor
		fakeActorV2      *v6fakes.FakeSetSpaceIsolationSegmentActorV2
		binaryName       string
		executeErr       error
	...
	BeforeEach(func() {
		...
		fakeActor = new(v6fakes.FakeSetSpaceIsolationSegmentActor)
		fakeActorV2 = new(v6fakes.FakeSetSpaceIsolationSegmentActorV2)
