...
var _ = Describe("app Command", func() {
	var (
		...
		fakeActor           *v6fakes.FakeV3AppActor
		fakeAppSummaryActor *v6fakes.FakeV2V3AppSummaryActor
		binaryName          string
		executeErr          error
		app                 string
	)
	...
	BeforeEach(func() {
		...
		fakeActor = new(v6fakes.FakeV3AppActor)
		fakeAppSummaryActor = new(v6fakes.FakeV2V3AppSummaryActor)
