...
var _ = Describe("marketplace Command", func() {
	...
	When("the user is logged in and targeting an org and space", func() {
		BeforeEach(func() {
			...
			fakeSharedActor.CheckOrgSpaceTargetedReturns(true)
	...
	When("the user is logged in and not targeting an org and space", func() {
		BeforeEach(func() {
			fakeSharedActor.IsLoggedInReturns(true)
			fakeSharedActor.CheckOrgSpaceTargetedReturns(false)
		})
