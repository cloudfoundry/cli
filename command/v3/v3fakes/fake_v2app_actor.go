...
func (fake *FakeV2AppActor) GetApplicationRoutes(appGUID string) ([]v2action.Route, v2action.Warnings, error) {
...
func (fake *FakeV2AppActor) GetApplicationRoutesReturns(result1 []v2action.Route, result2 v2action.Warnings, result3 error) {
...
func (fake *FakeV2AppActor) GetApplicationRoutesReturnsOnCall(i int, result1 []v2action.Route, result2 v2action.Warnings, result3 error) {
	fake.GetApplicationRoutesStub = nil
...
var _ v3.V2AppActor = new(FakeV2AppActor)
