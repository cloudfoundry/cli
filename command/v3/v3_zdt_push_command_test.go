...
var _ = Describe("v3-zdt-push Command", func() {
	var (
		...
		fakeZdtActor    *v3fakes.FakeV3ZeroDowntimeVersionActor
		fakeV3PushActor *v3fakes.FakeOriginalV3PushActor
	...
	BeforeEach(func() {
		...
		fakeZdtActor = new(v3fakes.FakeV3ZeroDowntimeVersionActor)
		fakeV3PushActor = new(v3fakes.FakeOriginalV3PushActor)
