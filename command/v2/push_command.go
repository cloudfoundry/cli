...
type PushCommand struct {
	...
	ApplicationStartTime int         `short:"t" description:"Maximum time (in seconds) to wait for the application to start and become healthy, other server side timeouts may apply"`
