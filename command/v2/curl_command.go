...
type CurlCommand struct {
	...
	HTTPData              flag.FilenameWithAt `short:"d" description:"HTTP data to include in the request body, or '@' followed by a file name to read the data from"`
	IncludeReponseHeaders bool                `short:"i" description:"Include response headers in the output"`
	OutputFile            flags.Filename      `long:"output" description:"Write curl body to FILE instead of stdout"`
