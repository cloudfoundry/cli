...
var _ = Describe("GetApplicationChanges", func() {
	...
	Describe("buildpack", func() {
		...
		DescribeTable("non-empty values",
			func(
				currentBuildpack types.FilteredString, currentDetectedBuildpack string,
				desiredBuildpack types.FilteredString, desiredDetectedBuildpack string,
			...
			Entry("new app with buildpack specified",
				...
				types.FilteredString{IsSet: true, Value: "some-new-buildpack"}, "",
				"", "some-new-buildpack",
			),
			Entry("existing buildpack with new buildpack specified",
				types.FilteredString{IsSet: true, Value: "some-old-buildpack"}, "",
				types.FilteredString{IsSet: true, Value: "some-new-buildpack"}, "",
				"some-old-buildpack", "some-new-buildpack",
			),
			Entry("existing detected buildpack with new buildpack specified",
				types.FilteredString{}, "some-detected-buildpack",
				types.FilteredString{IsSet: true, Value: "some-new-buildpack"}, "",
