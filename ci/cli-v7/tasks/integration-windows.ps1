...
ginkgo.exe -r -nodes=16 -tags="V7" -flakeAttempts=2 -slowSpecThreshold=60 -randomizeAllSpecs ./integration/shared/isolated ./integration/v7/isolated ./integration/v7/plugin ./integration/shared/experimental ./integration/v7/experimental ./integration/v7/push
