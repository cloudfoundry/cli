...
type CreateSpaceQuotaCommand struct {
	...
	IndividualAppInstanceMemory flags.MemoryWithUnlimited `short:"i" description:"Maximum amount of memory an application instance can have (e.g. 1024M, 1G, 10G). -1 represents an unlimited amount. (Default: unlimited)"`
...
func (_ CreateSpaceQuotaCommand) Setup(config commands.Config, ui commands.UI) error {
	return nil
}
