...
type CreateQuotaCommand struct {
	...
	IndividualAppInstanceMemory string      `short:"i" description:"Maximum amount of memory an application instance can have (e.g. 1024M, 1G, 10G). -1 represents an unlimited amount."`
...
func (_ CreateQuotaCommand) Setup() error {
	return nil
}
